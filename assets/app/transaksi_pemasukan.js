(function ($) {
			...
			{ data: "Keterangan" },
			{
				...
				render: function (data, type, row, meta) {
					return type === "display"
						? '<a data-id="' +
								data +
								'" id="edit_trans_pemasukan" class="text-success mr-4" title="Edit" data-toggle="tooltip"><i class="fas fa-edit"></i></a>' +
								'<a data-id="' +
								data +
								'" id="hapus_trans_pemasukan" class="text-danger" title="Delete" data-toggle="tooltip"><i class="fas fa-trash-alt"></i></a>'
						: data;
				},
			},
		],
	...
	$("#datatable_pemasukan tbody").on(
		"click",
		"#edit_trans_pemasukan",
		function () {
			$("#TransaksiPemasukanAdd").modal();
